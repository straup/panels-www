...
$("#header-show").hide()}else{$("#editor").removeAttr("data-panel-title");$("#header-delete").hide()}$("#header-source").show();$("#header-stuff").hide()}
...
function panels_view_source(){$("#editor").hide();$("#header-source").hide();$("#header-stuff").show();var a=sketchpad.json();if(panels_is_empty(a))return false;a=panels_generate_svg(a);a=$("<div/>").text(a).html();$("#svg").html(a);$("#svg").show()}function panels_view_stuff(){$("#svg").html("");$("#svg").hide();$("#editor").show();$("#header-source").show();$("#header-stuff").hide()}
