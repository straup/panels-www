...
function panels_load_panels(){panels_storage_list(function(a){for(var c=a.length,b='<option value="-1">...</option>',d=/^pending_(.*)/,e=0;e<c;e++)if(!a[e].match(d)){b+='<option value="';b+=a[e];b+='">';b+=a[e];b+="</option>"}a=document.getElementById("load-sel");a.innerHTML=b;a.style.display="block"})}function panels_open_canvas(a){var c=a.value;panels_storage_load(c,function(b){panels_new_panel(b,c)})}
